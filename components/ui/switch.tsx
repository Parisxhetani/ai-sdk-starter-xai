...
>(({ className, ...props }, ref) => (
  ...
  >
    <SwitchPrimitives.Thumb
      className={cn(
        "switch-thumb-theme pointer-events-none block h-5 w-5 rounded-full shadow-[0_2px_6px_rgba(12,22,17,0.25)] ring-0 transition-transform duration-200 data-[state=checked]:translate-x-5 data-[state=unchecked]:translate-x-0",
      )}
    />
  </SwitchPrimitives.Root>
))
